    ...
    E2SM_RC_RANFunctionDefinition_t* ranfunc_desc)
{
    ...
    memcpy(control_style0->ric_ControlStyle_Name.buf,
           controlStyleName0Buffer,
           controlStyleName0BufferSize);
    control_style0->ric_ControlStyle_Name.size = controlStyleName0BufferSize;

    // these two were not present in the spec in this control style but just in the second, remove
    // if they lead to crash
    ...
    control_style0->ric_ControlAction_List =
        (RIC_ControlStyle_Item::RIC_ControlStyle_Item__ric_ControlAction_List*)
            calloc(1, sizeof(RIC_ControlStyle_Item::RIC_ControlStyle_Item__ric_ControlAction_List));
    ...
    control_action0->ric_ControlAction_Name.buf = (uint8_t*)calloc(1, controlActionName0BufferSize);
    memcpy(control_action0->ric_ControlAction_Name.buf,
           controlActionName0Buffer,
    ...
    control_action0->ran_ControlParameters_List =
        (RIC_ControlAction_Item::RIC_ControlAction_Item__ran_ControlParameters_List*)calloc(
            1,
            sizeof(RIC_ControlAction_Item::RIC_ControlAction_Item__ran_ControlParameters_List));
    ...
    memcpy(ranParameter0->ranParameter_Name.buf,
           ranParameter0NameBuffer,
    ...
    memcpy(ranParameter1->ranParameter_Name.buf,
           ranParameter1NameBuffer,
    ...
    memcpy(control_style1->ric_ControlStyle_Name.buf,
           controlStyleName1Buffer,
    ...
    control_action1->ric_ControlAction_Name.buf = (uint8_t*)calloc(1, controlActionName1BufferSize);
    memcpy(control_action1->ric_ControlAction_Name.buf,
           controlActionName1Buffer,
    ...
    memcpy(ranParameter2->ranParameter_Name.buf,
           ranParameter2NameBuffer,
    ...
    memcpy(ranParameter3->ranParameter_Name.buf,
           ranParameter3NameBuffer,
    ...
    ranfunc_desc->ric_ControlStyle_List =
        (E2SM_RC_RANFunctionDefinition::E2SM_RC_RANFunctionDefinition__ric_ControlStyle_List*)
            calloc(1,
                   sizeof(E2SM_RC_RANFunctionDefinition::
